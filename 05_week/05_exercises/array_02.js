...
const planetLog = (arr) => {
    for (let i = 0; i < arr.length; i++) {
        console.log(`Planet: ${arr[i]}, Index: ${i}`)
    }   
}
...
*/
// Write your code here
const wowDataLog = (arr) => {
    for (let i = 0; i < arr.length; i++) {
        console.log(`Item: ${arr[i]}, Index: ${i}, Type: ${typeof arr[i]}`)
    }
}

//Another solution, to use 'forEach' method
...
*/
// Write your code here
const commonCourse = (arr1, arr2) => {
    for (let course of arr1) {
        arr2.find((a) => a === course) && console.log(`Common course: ${course}`) 
    }
}
...
*/
// Write your code here
const logEveryLetter = (arr) => {
    for (let item of arr) {
        console.log(`Letters in ${item}: ${item.split('')}`)
    }
}

logEveryLetter(furniture)
...
*/
// Write your code here
const getPositiveTemperatures = (temps) => {
    return temps.filter((a) => a > 0)
}
